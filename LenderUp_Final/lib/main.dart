...
void main() {
  runApp(MultiProvider(providers: [
    ChangeNotifierProvider<Dompet>(create: (_) => Dompet()),
    ChangeNotifierProvider<Transaksi>(create: (_) => Transaksi()),
    ChangeNotifierProvider<PinjamanInfo>(create: (_) => PinjamanInfo()),
  ], child: MyApp()));
}
